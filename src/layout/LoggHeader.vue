    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                <router-link slot="title" class="nav-link" to="/resume">
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.facebook.com/wei.logg.william" target="_blank" rel="noopener"
                       data-toggle="tooltip" title="View me on Facebook">
                        <i class="fa fa-facebook-square"></i>
                        <span class="nav-link-inner--text d-lg-none">Facebook</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.linkedin.com/in/cheahweilogg/" target="_blank" rel="noopener"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://github.com/9868weilogg"
